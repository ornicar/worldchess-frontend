...
import {NewsResourceService} from '../../broadcast/chess-footer/news/news-resource.service';
import {NewsPaginationService} from '../../broadcast/chess-footer/news/news-pagination.service';
...
export class NewsGroupComponent implements OnInit, OnDestroy {
  ...
  getImageUrl(news: INews): string {
    return news.image && `url(${news.image.full})`;
  }
}
